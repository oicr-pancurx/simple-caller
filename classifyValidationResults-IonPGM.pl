...
my $reference_coverage_minimum = 50;
my $primary_coverage_minimum = 50;

my $reference_somatic_freq_max = 0.02;
my $primary_somatic_freq_min = 0.02;
my $primary_variant_reads_min = 10;
...
my $indel_homopolymer_freq_max = 0.02;
my $doHomopolymerFilter = 1;
